...
* [Ungoogled Chromium](https://ungoogled-software.github.io/) - 以前在電腦上會用這個處理剛才提到的那些網站，但每次都要重裝 Ad Blocker 太麻煩了，所以改用 Brave
...
_如果你想和我[聯絡](https://tux24.xyz/contact)的話，歡迎來信 tux24xyz@protonmail.com !_
...
* [Protonmail](https://mail.proton.me) - 我的主要 E-mail 服務商。我還是有在用 Gmail（學校會強迫你用），但我設定了轉寄讓我不用開啟 Gmail 的客戶端
...
（2025-08-13 的我：其實有一種作法可以躲過 DRM ... [不要用買的就好了](https://archive.org/details/booksbylanguage)）
