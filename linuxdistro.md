...
順帶一提，身為 Mac 使用者的官大為老師，曾經推薦 Pop!_OS … 不過那是 2021 年 9 月的事了。
### 難度等級 - 中
如果你們中的有些人在 Windows/Mac 使用者中算是會一些進階使用技巧、會用電腦做一些專業的事、是「Office 大師」、「Adobe 大師」、會看那些[藍藥丸科技頻道]()。那恭喜你來到這個級別。

如果你對自己不太有自信，請回到上一級，不要勉強，我很怕失去你們的注意力。

這一級和上一級的差別是我選了自訂性更強的 KDE（預設界面接近 Windows 11，可以改的完全不一樣） 來作為 DE。我首推 Nobara KDE，我用過，非常適合新手和玩家使用。如果你完全不想玩遊戲，也可以選擇 Fedora Spin KDE 或 Kubuntu。

新增一個：Zorin OS。這個發行版比較特殊，雖然用的是 GNOME 桌面環境，但被它們團隊魔改的超像 Windows。如果你是完全不想自訂的人，想要最接近 Windows 的使用體驗，請選 Zorin OS。

一樣，如果你想要比較接近 Mac OS 的使用體驗，我還是推薦上一級的選項。
### 難度等級 - 軟體玩家
我在此先假設你玩的是那些比較「認真」的遊戲，而不是「幼稚」的遊戲。嗯...懂的都懂。

我問個問題：顯卡、CPU、記憶體是什麼。

好，如果你答的出來，我們繼續。

我唯一推薦 Nobara KDE（或 GNOME，不過長的比較不像 Windows...），如果你想玩遊戲的話，Nobara 幫你把所需的一切都打理好了，只要開始玩就好了。我之後會再寫一篇 Gaming 須知。

如果你有 Steam Deck，桌面模式採用的就是 KDE。如果你想在電腦上也玩遊戲，Nobara KDE 是你最好的選擇。
### 難度等級 - 硬體玩家
如果你會自己組電腦，那你可以直接來這一級了。你很有可能會自己裝 Windows 到電腦上，所以圖形化安裝肯定難不倒你。嗯...那還有什麼會成為你的關卡呢？

那可能是終端機吧。我推薦想挑戰自己的人試試看 Endeavour OS KDE 或 ArcoLinuxB KDE。不過不要第一次就試，建議先從前面提過的發行版先開始，用 KDE 桌面環境你會比較熟悉預設介面。到這個等級，有興趣的人可以開始在 YT 上找一些 KDE 美化的教學影片並照著做，畢竟界面好看也是 Linux 的最大優點之一。如果過程中遇到問題也可以[寫信來問我](tux24xyz@protonmail.com)，我會很樂意回信幫忙的。
### 難度等級 - Mac
如果你是個算是會用 Mac 的使用者，那我推薦使用 GNOME 桌面環境的發行版。

同樣的桌面環境，只要在自由度夠高的發行版中就有許多選擇。

以三大系來說
Debian：Pop!_OS（它的桌面環境已經不是 GNOME 了，但也是 GNOME 的改版）、Zorin OS（如果你擅長自定義桌面，我不太推薦這個給想要舒服使用的人）
Arch（先試過其他系的發行版再說）：Endeavour OS GNOME、ArcoLinuxB GNOME
Fedora：Fedora、Nobara GNOME（如果你想玩遊戲）
### 難度等級 - 不重要
如果你已經不在乎難度，一開始的小測驗符合 6＆7 項。那你可以試著挑戰自己，使用 Endeavour OS 或 ArcoLinux，這些發行版不會有最好的支援，但我覺得是鍛鍊除錯、動手能力，前往下一階段的好地方。
## 等等...你是不是漏了什麼…
是的，從文章開始到現在，「Ubuntu」這個字我一次都沒提過。原因是它的母公司 Cannonical 強推自己出品的 Snap（我在安裝軟體方式 3 有提到），在 Ubuntu 下使用 apt 命令安裝軟體預設會被強制改成 Snap 安裝，Ubuntu 自己的軟體中心（類似 App Store）也不例外。而且 Snap 的伺服器不夠多，軟體又是閉源的，種種原因讓我很反感。

還有 Manjaro，我人生第一個接觸的發行版。安裝軟體方式 3 和一開始 Tierlist 的影片有提到 Manjaro 的問題。還有[這個](https://forum.gamer.com.tw/C.php?bsn=60030&snA=628831)、[這個](https://youtu.be/oVlD17OjFAc)、[跟這個](https://youtu.be/ZY_HB9lOJhk)。我想也不用多講了，哪有使用 Arch 系發行版卻不能用 AUR 的道理。

Debian 和 Arch 不在這單純只是不適合新手。就像一開始講的，如果你是對技術有興趣，不怕困難的人應該使用來自最源頭的發行版，並享受自己動手、自由度超高的樂趣（這在 Windows/Mac 絕對體驗不到）。
### 我自己用的發行版
我現在打這篇文章是在裝了 Arch + LARBS 的破筆電上，**我不推薦使用你不完全知道它做了什麼事的一鍵安裝腳本**。用腳本沒問題，但你要知道它做了什麼。我是先裝了才開始學，所以也花了超多的時間除錯（我的 Nvidia 獨顯到現在還不能用，玩遊戲請找 Nobara）。我玩遊戲的電腦目前裝的是 Nobara KDE。我用過 Linux Mint Cinnamon、Manjaro KDE、Artix + i3 WM 等等發行版。還沒用過 GNOME，之後打算試試看 ArcoLinuxB GNOME。
## 總結
終於結束這超長的文章了，我想知道自己有什麼講錯、不夠全面的地方、想聽更多不同的意見。我還沒想好要如何建立留言系統，所以請每位有空的熱心讀者[寫信](tux24xyz@protonmail.com)來分享建議，讓我改進我的文章！

如果你在現實生活中認識我本人，請不要吝惜時間，直接問我問題或是分享建議！
